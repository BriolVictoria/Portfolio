...
<footer>
    ...
    <div class="footer_columns">
        ...
        <div class="coordonnees">
            ...
            <a title="<?= __hepl('Vers mon email') ?>" target="_blank" class="content"
               href="mailto:Victoria.briol@student.hepl.be">Victoria.briol@student.hepl.be</a>

            <a title="<?= __hepl('Vers mon email personel') ?>" target="_blank" class="content"
               href="mailto:Victoriabriol5@gmail.com">Victoriabriol5@gmail.com</a>
        </div>

        <div class="sociaux">
            <h4 class="titre_footer"><strong class="highlight"><?= __hepl('Réseaux sociaux') ?></strong></h4>
            <a title="<?= __hepl('Vers mon instagram') ?>" target="_blank" class="content"
               href="https://www.instagram.com/victoria_briol/">Instagram : victoria_briol</a>
            <a title="<?= __hepl('Vers mon gitHub') ?>" target="_blank" class="content"
               href="https://github.com/BriolVictoria">GitHub : VictoriaBriol</a>
        </div>
    ...
    <div class="infos_supp">
        <p class="blog_info">©
            2025 <?= get_bloginfo('name'); ?><?= __hepl('. Tous droits réservés. Créé par ') ?><?= get_bloginfo('name'); ?></p>
